  ...
  return (
    <div className="pytDevMainContainer">
      <div className="pytDevContainer" style={{ alignItems: 'center' }}>
        <div className="tve_shortcode_rendered" style={{ width: '95%' }}>
          <p></p>
          <h1 style={{ textAlign: 'left', margin: '0 0 10px' }}>
            EC Infosolutions LLC Terms of Service
          </h1>
          <p>
            By using our website &amp; software solutions (“Service”), you are
            agreeing to be bound by the following terms and conditions (“Terms
            of Service”).
          </p>
          <p>
            EC Infosolutions, LLC (“Company”) reserves the right to update and
          ...
          <p>
            ...
            their own logins under your account). You may not use the Service
            for any illegal purpose or to violate any laws in your jurisdiction
          ...
          <p>
            ...
            Service with or without notice. The Company shall not be liable to
          ...
          <p>
            ...
            provided on an “as is” and “as available” basis. Technical support
            is only provided via email. You understand that the Company uses
            ...
            required to run the Service. You must not modify, adapt or hack the
            Service. Verbal, physical, written or other abuse (including threats
            of abuse or retribution) of any Service customer, Company employee
          ...
          <p>
            The Terms of Service constitutes the entire agreement between you
            and the Company and govern your use of the Service, superceding any
            prior agreements between you and the Company (including, but not
            limited to, any prior versions of the Terms of Service).
          </p>
          <h1 style={{ textAlign: 'left', margin: '0 0 10px' }}>
            EC Infosolutions Pvt Ltd Terms of Service
          </h1>
          <p>
            This website is operated by{' '}
            <strong>EC Infosolutions Private Limited</strong>. Throughout the
            site, the terms “we”, “us” and “our” refer to{' '}
            <strong>EC Infosolutions Private Limited</strong>. &nbsp;
            <strong>EC Infosolutions Private Limited</strong>&nbsp;offers this
          ...
          <h3 className="heading-6">Section 1 – Online Store Terms</h3>
          <p>
          ...
          <h3 className="heading-6">Section 2 – General Conditions</h3>
          <p>
          ...
          <h3 className="heading-6">Section 5 – Products or Services</h3>
          <p>
          ...
          <h3 className="heading-6">Section 7 – Optional Tools</h3>
          <p>
          ...
          <h3 className="heading-6">Section 8 – Third-Party Links</h3>
          <p>
          ...
          <h3 className="heading-6">Section 10 – Personal Information</h3>
          <p>
          ...
          <h3 className="heading-6">Section 12 – Prohibited Uses</h3>
          <p>
          ...
          <p>
            In no case shall &nbsp;
            <strong>EC Infosolutions Private Limited</strong>, our directors,
          ...
          <h3 className="heading-6">Section 14 – Indemnification</h3>
          <p>
            You agree to indemnify, defend and hold harmless{' '}
            <strong>EC Infosolutions Private Limited</strong> and our parent,
          ...
          <h3 className="heading-6">Section 15 – Severability</h3>
          <p>
          ...
          <h3 className="heading-6">Section 16 – Termination</h3>
          <p>
          ...
          <h3 className="heading-6">Section 17 – Entire Agreement</h3>
          <p>
          ...
          <h3 className="heading-6">Section 18 – Governing Law</h3>
          <p>
          ...
          <h3 className="heading-6">Section 21 – Contact Information</h3>
          <p>
          ...
          <h1>Refund Policy</h1>
          <p>
            Our policy lasts 30 days or given Trial period of the subscription
            based Software on the cloud. If 30 days have gone by since your
          ...
          <ul className="list-marked">
            <li>Gift cards</li>
            <li>Subscription based or Downloadable software products</li>
          </ul>
          <p>
            To complete your return, we require a receipt or proof of purchase.
          </p>
          <p>Any item that is returned more than 30 days after delivery.</p>
          <h3 className="heading-6">Refunds (if applicable)</h3>
          <p>
          ...
          <h3 className="heading-6">Late or missing refunds (if applicable)</h3>
          <p>
          ...
          <p>
            ...
            refund yet, please contact us at hello@ecinfosolutions.com.
          </p>
          <h3 className="heading-6">Sale items (if applicable)</h3>
          <p>
            Only regular priced items may be refunded, unfortunately sale items
            cannot be refunded.
          </p>
          <h3 className="heading-6">Exchanges (if applicable)</h3>
          <p>
            We only replace items if they are defective or damaged. If you need
            to exchange it for the same item, send us an email at
            hello@ecinfosolutions.com and send your item to: EC Infosolutions
            Pvt Ltd. 102, Network Savoy, Baner Balewadi Road, Pune 411045
          </p>
          <p>
